...
// From 21st.dev (@uniquesonu/data-table-filter), adapted: dropped the standalone demo/example
// block, kept only the reusable component + types.
              ...
              {options.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && <Check className={cn("ml-auto h-4 w-4", isSelected ? "opacity-100" : "opacity-0")} aria-hidden="true" />}
                  </CommandItem>
                );
              })}
            </CommandGroup>
            ...
            <>
              ...
              <div className="flex items-center justify-between p-1">
                ...
                <Button
                  ...
                  className={cn("h-7 text-xs text-red-500 hover:bg-red-500/10 transition-colors", isMultiSelect ? "w-1/2" : "w-full")}
                >
                  Clear Filter
                </Button>
              </div>
