...
export const metadata = {
  title: "About — ClickBank Studio",
  description: "Why ClickBank Studio exists and how it works.",
};

export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:py-20">
      <h1 className="text-3xl font-bold text-zinc-100 sm:text-4xl">About ClickBank Studio</h1>
      ...
      <div className="mt-10 space-y-8">
        ...
        <section>
          ...
          <p className="mt-2 text-sm leading-relaxed text-zinc-400">
            ClickBank Studio never touches your ClickBank commissions, and it never holds your ad
        ...
        <section>
          ...
          <p className="mt-2 text-sm leading-relaxed text-zinc-400">
            ...
            it properly. ClickBank Studio is built to close that specific gap, not to replace your
